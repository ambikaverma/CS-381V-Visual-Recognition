% Following program computes SIFT descriptors of object template and scene
% images.
% Further on the set of descriptors obtained we apply raw thresholding,
% ratio test and RANSAC one after the other. After each step the surviving
% matched descriptors are plotted.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
clear all
close all
clc
